...
static const uint16_t pAuxRamImage[] = {
    ...
    /*0x00C0*/ 0x6436, 0xBDB7, 0x241A, 0xA6FE, 0xADB7, 0x641A, 0xADB7, 0x0000, 0x0076, 0x007D, 0x00A0, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000, 
    /*0x00E0*/ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x640E, 0x460E, 0x7001, 0x14A1, 0x0001, 0x0C67, 0xADB7, 0xF502, 0xFD47, 0xFD47, 
    /*0x0100*/ 0xFD47, 0x7041, 0x1462, 0xFB4D, 0x8609, 0x7101, 0x6431, 0x2531, 0xA6FE, 0xFB00, 0x7078, 0xFB54, 0x7018, 0xFB4C, 0x7003, 0xFB4C, 
    /*0x0120*/ 0xFD47, 0xFB4C, 0x1465, 0x6403, 0x001F, 0x8B2C, 0xFDB1, 0x8902, 0x0C75, 0x14AE, 0x086C, 0x8201, 0x0C6C, 0x0001, 0x0C67, 0xADB7, 
    /*0x0140*/ 0xADB7, 0xF007, 0x1462, 0x86FF, 0x63F8, 0xEB51, 0x8680, 0x6000, 0xED8F, 0xEB49, 0xFD47, 0xEB49, 0x1465, 0xADB7, 0x1462, 0x7079, 
    /*0x0160*/ 0xFB55, 0x71FB, 0xFB54, 0xFD47, 0xFB54, 0x1465, 0x4431, 0x4400, 0xADB7
};
...
static void scifTaskResourceInit(void) {
    ...
    scifInitIo(0, AUXIOMODE_OUTPUT | (2 << BI_AUXIOMODE_OUTPUT_DRIVE_STRENGTH), -1, 0);
